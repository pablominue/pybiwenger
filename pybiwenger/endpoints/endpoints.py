...
class Endpoints():
    ...
    def daily_squad_market_endpoint(league_name: str = "SIMPS"):
        ...
        balance = client.account.leagues

        league_info = [
            x
            for x in client.account.leagues
        ...
        def get_and_enrich_players_data(players, roster):
            for player in players:
                ...
                renamed_enriched_info = Parsing.rename_points_history_dict_for_inference(enriched_info, roster = roster)
